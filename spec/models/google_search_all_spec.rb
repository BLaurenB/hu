...
describe " Google Search All" do
    ...
    it "creates new GoogleSearchWeekly instances from a hash" do
      ...
      google_search = GoogleSearchAll.new(csv_hash)
      expect(google_search.all_stats.count).to eq(6)
    end
    ...
    it "calculates the average per week" do
      ...
      google_search = GoogleSearchAll.new(csv_hash)
      expect(google_search.standard_average.to_i). to eq(7)
      expect(google_search.word_1_average.to_i). to eq(0)
      expect(google_search.word_2_average.to_i). to eq(0)
      expect(google_search.word_3_average.to_i). to eq(1)
      expect(google_search.word_4_average.to_i). to eq(0)
    ...
    it "calculates the word score against the standard" do
      ...
      expect(google_search.word_1_insight).to eq(3)
      expect(google_search.word_2_insight).to eq(3)
      expect(google_search.word_3_insight).to eq(15)
      expect(google_search.word_4_insight).to eq(8)
